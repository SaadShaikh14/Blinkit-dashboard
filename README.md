⚡ Blinkit Quick Commerce Performance Dashboard
A comprehensive, interactive Power BI report designed to analyze sales, inventory distribution, and dark store performance for Blinkit's 10-minute delivery ecosystem.

📖 Short Description / Purpose
The Blinkit Performance Dashboard is a dynamic data visualization tool built to track and optimize quick commerce operations. It breaks down total sales, average customer ratings, and inventory distribution across various outlet sizes and item categories. This tool is intended for use by operations managers, inventory analysts, and business strategists to identify top-selling products, monitor outlet growth, and ensure the 10-minute delivery model remains profitable and efficient.

🛠️ Tech Stack
This dashboard was built using the following tools and technologies:
📊 Power BI Desktop: Main data visualization platform used to create the interactive dashboard.
📂 Power Query: Utilized for data cleaning, handling missing values, and reshaping the raw dataset.
🧠 DAX (Data Analysis Expressions): Used to create custom calculated measures and KPIs (e.g., Total Sales, Average Rating).
📝 Data Modeling: Established a robust schema to connect sales data with outlet metadata for seamless cross-filtering.
📁 File Format: Blinkit.pbix for the core development file and .png for repository previews.
🗄️ Data Source

Source: Aggregated quick commerce sales dataset representing Blinkit's operational metrics.

Structure: The dataset contains thousands of order records detailing item visibility, 
item type (e.g., Dairy, Snacks, Fresh Produce), 
outlet establishment year, outlet size, 
customer ratings, and total sales figures.
